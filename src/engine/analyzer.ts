...
const rules: Rule[] = [
  ...
  { id:'SEC012', title:'Weak cryptographic hash', severity:'medium', re:/\b(?:md5|sha1)\s*\(/i, message:'MD5/SHA-1 are unsuitable for security-sensitive hashing. Prefer modern primitives.' },
